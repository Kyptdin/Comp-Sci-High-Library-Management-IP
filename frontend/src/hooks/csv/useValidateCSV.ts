    ...
    const uploadChunkedRows = (
        ...
        setTimeout(() => {
            csvUploadChunkedRows.forEach(
                ...
                const calculatedIndividualDelayTime = index * individualUploadTime * 1000;
                ...
                setTimeout(() => {
                    fetchBookFromIsbn(isbnApiLink, {
                        ...
                        createBook({
                            ...
                            total_copies_within_school: Number(csvUploadRow.csvRowMetaData.COPIES),
                        }).then(() => {
